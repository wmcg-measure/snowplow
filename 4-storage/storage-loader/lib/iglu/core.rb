...
module Iglu
  ...
  class SchemaVer
    ...
    def ==(other)
      other.model == @model and other.revision == @revision and other.addition == @addition
    end
  end
  ...
  class SchemaKey
    ...
    def ==(other)
      other.vendor == @vendor and other.name == @name and other.format == @format and other.version == @version
    end
  end
